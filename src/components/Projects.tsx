...
export const Projects = () => {
  ...
  return (
    <section id="dashboard" className="py-32 relative overflow-hidden">
      ...
      {/* Crystal orbs */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-accent-cyan/10 blur-3xl animate-crystal animate-drift" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-accent-purple/10 blur-3xl animate-crystal animate-drift" style={{ animationDelay: '2s' }} />
      
      {/* Floating particles */}
      <div className="absolute top-40 right-1/3 w-3 h-3 rounded-full bg-accent-green/40 animate-particle-float" />
      <div className="absolute bottom-40 left-1/3 w-2 h-2 rounded-full bg-accent-cyan/30 animate-particle-float" style={{ animationDelay: '1s' }} />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={titleRef as any} className="text-center mb-20 scroll-reveal">
          <div className="inline-block mb-4 animate-scale-pulse">
            <span className="text-xs sm:text-sm uppercase tracking-[0.3em] text-accent-cyan font-bold px-4 py-2 rounded-full border border-accent-cyan/30 bg-accent-cyan/5 backdrop-blur-sm animate-glow-pulse">
              Dashboard Analytics
            </span>
          </div>
          ...
          {dashboardCards.map((card, index) => {
            ...
            return (
              <div
                key={card.id}
                ref={cardRef as any}
                className="group relative preserve-3d scroll-reveal-scale"
              >
                ...
                <div className="relative h-full">
                  ...
                  {/* Main card */}
                  <div className="relative backdrop-blur-glass bg-gradient-to-br from-glass-bg to-transparent border border-glass-border rounded-2xl p-6 md:p-8 overflow-hidden transition-all duration-700 group-hover:border-accent-cyan/50 group-hover:shadow-glow-aqua preserve-3d group-hover:scale-110 group-hover:-translate-y-2">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full backdrop-blur-glass bg-glass-bg border border-glass-border hover:border-accent-green hover:shadow-glow-green transition-all duration-300">
